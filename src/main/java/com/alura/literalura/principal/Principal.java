            ...
            switch (opcion) {
                case 1:
                    ...
                    try {
                        ...
                        String json = consumoAPI.obtenerDatos(BASE_URL + encodedTitulo.replace(" ","+"));
                        RespuestaLibroDTO respuestaLibrosDTO = convierteDatos.obtenerDatos(json, RespuestaLibroDTO.class);
                                    ...
                                    if (libroExistente.isPresent()) {
                                        ...
                                        Autor autor = autorService.obtenerAutorPorNombre(primerAutorDTO.getNombre())
                                                .orElseGet(() -> {
                                                    ...
                                                    nuevoAutor.setAnoDeNacimiento(primerAutorDTO.getAnoDeNacimiento());
                                                    nuevoAutor.setAnoDeFallecimiento(primerAutorDTO.getAnoDeFallecimiento());
                ...
                case 4:
                    ...
                    scanner.nextLine();
                    List<Autor> autoresVivos = autorService.listarAutoresVivosEnElAno(ano);
